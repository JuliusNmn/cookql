 ...
 * @id java/sql-injection-addBatch
 * @tags security
...
import AddBatchSqlInjectionFlow::PathGraph
...
select sink.getNode(), source, sink,
  "Possible SQL injection: data from $@ reaches Statement.addBatch() without sanitization.",
